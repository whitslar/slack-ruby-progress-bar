...
describe SlackRubyProgressBar do
  let(:progress_bar) { SlackRubyProgressBar.new(channel: 'foo', slack_token: 'bar', bar_color: :black) }
  ...
  describe '.finish' do
    ...
    it 'should set progress_text to the elapsed time' do
  ...
  describe '.clear' do
    ...
    it 'should clear progress and progress_text' do
  ...
  describe '.rendered_bar' do
    ...
    context 'without percentage' do
      ...
      describe 'and 10% progress' do
        ...
        it { is_expected.to eq("\u{2B1B}" + "\u{2B1C}" * 9) }
      end
      ...
      describe 'and 20% progress' do
        ...
        it { is_expected.to eq("\u{2B1B}" * 2 + "\u{2B1C}" * 8) }
      end

      describe 'and 100% progress' do
        before { progress_bar.progress = 100 }

        it { is_expected.to eq("\u{2B1B}" * 10) }
      end
    end
  end
end
